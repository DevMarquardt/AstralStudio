        ...
        <div className="bg-[#1F1E1E] h-[5.5rem]">
            <div className="h-full flex items-center">
                ...
                <div className="flex justify-center gap-12 w-full">
                    <h1 className="text-white text-2xl font-semibold ">Jogar</h1>
                    <h1 className="text-white text-2xl font-semibold ">Loja</h1>
                    <h1 className="text-white text-2xl font-semibold ">Explorer</h1>
                    <h1 className="text-white text-2xl font-semibold ">Ajuda</h1>
                </div>

                <div className="flex gap-6 pr-4">

                    <svg width="40" height="auto" viewBox="0 0 314 314" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg width="40" height="auto" viewBox="0 0 417 417" fill="none" xmlns="http://www.w3.org/2000/svg">
